...
/**
 * Controller for exceptions within the application.<br>
 * Turns specific exceptions into matching {@link ResponseEntity ResponseEntitites} with proper
 * http response codes.
 */
@ControllerAdvice
@Controller
public class ExceptionController extends ResponseEntityExceptionHandler implements ErrorController {
	 ...
	 *
	 * @return ResponseEntity
	 * @throws Exception Throws exception if class has a response status annotation.
	 */
