...
/**
 * Repository for Products.<br>
 * Implements {@link PagingAndSortingRepository} in order to provide paging and sorting.
 * The controller will not be able to filter results.<br>
 * Instead of security on the controllers the products are secured directly in the
 * repository.
 */
@Repository
